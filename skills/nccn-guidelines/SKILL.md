...
3. 🔴 CHECKPOINT · STOP before China download: show the exact title, source, language, and version, then get clear permission before one `download_guideline` call with `confirm_license=true`.
